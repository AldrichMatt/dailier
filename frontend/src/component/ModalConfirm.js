...
export default function ModalConfirm({state, message}) {
                ...
                <div className="sm:flex sm:items-center sm:justify-center pt-5">
                  <div className="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:size-10">
                    {(() => {
                        switch (state) {
                            case 'danger' :
                                return <ExclamationTriangleIcon aria-hidden="true" className="size-6 text-red-600" />
                            case 'notify' : 
                                return <ExclamationCircleIcon aria-hidden="true" className="size-6 text-yellow-600" />
                            case 'confirm' :
